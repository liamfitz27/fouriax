...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--data-path",
        type=str,
        default=str(EXPERIMENTS_DATA_DIR / "indian_pines" / "Indian_pines.mat"),
    )
    parser.add_argument(
        "--wavelengths-path",
        type=str,
        default=str(EXPERIMENTS_DATA_DIR / "indian_pines" / "wavelengths.npy"),
    )
    parser.add_argument("--artifacts-dir", type=str, default=str(EXPERIMENTS_ARTIFACTS_DIR))
